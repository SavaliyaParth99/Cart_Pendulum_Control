 ...
 *
 *         int16 y1 = Fixedpt_Speed_Control(int16 u1, int32 u2, int16  u3)
 *
 *    Simulink version           : 10.5 (R2022a) 13-Nov-2021
 *    C source code generated on : 23-Jan-2024 15:27:06
 *
...
/**
     ...
     def.OutputFcnSpec = 'int16 y1 = Fixedpt_Speed_Control(int16 u1, int32 u2, int16  u3)';
     def.HeaderFiles = {'Fixedpt_Speed_Control.h'};
     def.SourceFiles = {'Fixedpt_Speed_Control.c'};
...
#define S_FUNCTION_NAME  ex_sfun_spsctrl
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "Fixedpt_Speed_Control", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *y1 = Fixedpt_Speed_Control(*u1, *u2, *u3);
}
