 ...
 *
 *         int16 y1 = spctrl_Speed(int16 u1, int32 u2, int32 u3)
 *
 *    Simulink version           : 10.5 (R2022a) 13-Nov-2021
 *    C source code generated on : 29-Jan-2025 20:50:58
 *
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "spctrl_Speed", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
