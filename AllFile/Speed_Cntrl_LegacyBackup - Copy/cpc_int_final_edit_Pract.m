...
KTD_D(1) = round(ktd_s(1) * 2^KTD_SHIFT);
KTD_D(2) = round(ktd_s(2) * 2^KTD_SHIFT);
KTD_D(3) = round(ktd_s(3) * 2^KTD_SHIFT);
KTD_D(4) = round(ktd_s(4) * 2^KTD_SHIFT);
...
fprintf('#define KTD_D: (%7d, %7d, %7d, %7d)  --> int 16.%d \n', KTD_D(1),KTD_D(2),KTD_D(3),KTD_D(4),KTD_SHIFT);
fprintf('\n');
