 ...
 *
 *         int16 y1 = spctrl(int16 u1, int16 u2, int32 u3, int16 u4)
 *
 *    Simulink version           : 10.5 (R2022a) 13-Nov-2021
 *    C source code generated on : 24-Jan-2024 17:22:25
 *
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "spctrl", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
